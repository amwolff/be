...
Metody o największych znaczeniu dla prywatności (czyli na przykład takie, które wprowadzają najwięcej entropii) zostaną szczegółowo omówione w niniejszym rozdziale.
