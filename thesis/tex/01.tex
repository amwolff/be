...
przykład adresy IP urządzeń i/lub \emph{cookies}. \emph{Fingeprinting}
przeglądarek po raz pierwszy opisał Eckersley \cite{eckersley2010unique}, jako
technikę, która pozwala serwerom sieciowym jednoznacznie zidentyfikować
urządzenie użytkownika za pomocą informacji wysyłanych przez przeglądarkę
internetową wtedy, kiedy te informacje są unikalne dla większości z nich,
tworząc ich \emph{fingerprint}. O relacji urządzeń i przeglądarek pomiędzy ich
użytkownikami traktuje 2.2.
